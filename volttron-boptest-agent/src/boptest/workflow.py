"""
Template workflow for boptest-agent
"""
...
class Interface:
    ...
    def populate_testcase_info(self):
    ...
    def initialize_testcase(self):
        ...
        if scenario is not None:
            ...
            self.final_time = np.inf
            self.total_time_steps = int(length / step)
        else:
            ...
            self.final_time = start_time + length
            self.total_time_steps = int(length / step)  # calculate number of timesteps, i.e., number of advance
    ...
    def advance_simulation(self, is_loop=True):
        # Simulation Loop
    ...
    def simulation_single_step(self, u=None):
    ...
    def run_workflow(self):
        ...
        """
        pass
        logging.info("=========== run_workflow NEW ++++++++++++++++++")

        self.populate_testcase_info()
        ...
        return kpi, result, forecasts, custom_kpi_result  # Note: originally publish these
